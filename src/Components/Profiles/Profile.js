...
import userSix from "../../Assets/user/user-14.png";
...
const Profile = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      const response = await axios.post("http://localhost:5000/userData", data);
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          ...
          <div className="mt-4">
            ...
            <p className="font-medium">
              {" "}
              {userDetails ? userDetails.Company_Name : "Loading..."}
            </p>
            <div className="mx-auto mt-4.5 mb-5.5 grid max-w-94 grid-cols-2 rounded-md border border-stroke py-2.5 shadow-1 dark:border-strokedark dark:bg-[#37404F]">
              <div className="flex flex-col items-center justify-center gap-1 border-r border-stroke px-4 dark:border-strokedark xsm:flex-row">
                <span className="font-semibold text-black dark:text-white">
                  {userDetails ? userDetails.item_count : "Loading..."}
                </span>
                <span className="text-sm">Items</span>
              </div>
              <div className="flex flex-col items-center justify-center gap-1 border-r border-stroke px-4 dark:border-strokedark xsm:flex-row">
                <span className="font-semibold text-black dark:text-white">
                  {userDetails ? userDetails.party_count : "Loading..."}
                </span>
            ...
            <div className="mx-auto max-w-180">
              ...
              <p className="mt-2 text-black dark:text-white">
                {userDetails ? userDetails.About : "Loading..."}
              </p>
            </div> */}
